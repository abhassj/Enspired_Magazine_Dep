          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-10 md:gap-12 text-brand-lightText dark:text-white text-center md:text-left">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-16 md:gap-24 w-full md:w-auto mt-4 md:mt-0">
              ...
              <div>
                ...
                <ul className="space-y-3 md:space-y-4 text-brand-lightMuted dark:text-white/70 font-light text-xs md:text-sm">
                  <li className="flex items-center justify-center md:justify-start space-x-3 hover:text-brand-lightText dark:hover:text-white transition-colors">
                    <Mail size={16} className="text-brand-pink shrink-0" />
                    <a href="mailto:enspiredmag@outlook.com">enspiredmag@outlook.com</a>
                  </li>
                  <li className="flex items-start justify-center md:justify-start space-x-3 hover:text-brand-lightText dark:hover:text-white transition-colors">
                    <Phone size={16} className="text-brand-pink shrink-0 mt-0.5" />
                    <div className="flex flex-col space-y-1 text-left">
                      <a href="tel:+447825282654" className="hover:text-brand-pink transition-colors">UK: +44 78252 82654</a>
                      <a href="tel:+27744613719" className="hover:text-brand-pink transition-colors">SA: +27 74 461 3719</a>
                    </div>
                  </li>
                </ul>
              </div>
