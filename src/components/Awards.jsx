...
const AwardsDesktop = () => {
  ...
  return (
    <section ref={containerRef} id="awards" className="relative py-12 md:py-20 bg-white dark:bg-brand-dark overflow-hidden">
      {/* Artistic animated floating orbs — parallax on desktop */}
...
/* Mobile: static blobs, no parallax */
const AwardsMobile = () => {
  return (
    <section id="awards" className="relative py-12 bg-white dark:bg-brand-dark overflow-hidden">
      {/* Static blobs — no parallax, reduced blur */}
      <div className="absolute top-[10%] left-[-10%] w-[300px] h-[300px] bg-brand-purple/10 dark:bg-brand-purple/5 rounded-full blur-[60px] pointer-events-none"></div>
      <div className="absolute bottom-[0%] right-[-10%] w-[350px] h-[350px] bg-brand-pink/10 dark:bg-brand-magenta/5 rounded-full blur-[60px] pointer-events-none"></div>
...
const Awards = () => {
  return isMobileDevice ? <AwardsMobile /> : <AwardsDesktop />;
};
